...
//        let oracle = RuntimeType.Closure(ObjectIdentifier(String.self), ObjectIdentifier(Int.self))
//        let runtimeType = step1.runtimeType
//        XCTAssertEqual(runtimeType.inputType, oracle.inputType)
//    }
