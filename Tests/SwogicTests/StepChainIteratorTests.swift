...
//
//    var step1 = TypedStep<String, Int> { (str) -> Int in
//        str.count
//    }
//    var step2 = TypedStep<Int, Double> { (i: Int) -> Double in
//        Double(i) + 3.5
//    }
//    var step3 = TypedStep<Double, String> { (d) -> String in
//        "Number is: " + String(d)
//    }
//
//    override func setUp() {
...
//        print(chain)
//
//        let c: AnySequence<TypedStep> = chain.dropFirst(3)
